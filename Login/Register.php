...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $cek = mysqli_query($conn, "SELECT * FROM tabel_user WHERE email='$email'");
    if (mysqli_num_rows($cek) > 0) {
        echo "<script>alert('Email sudah digunakan!');</script>";
    } else {
        $sql = "INSERT INTO tabel_user (nama, phone, email, password, role) 
                VALUES ('$nama', '$phone', '$email', '$password', '$role')";
