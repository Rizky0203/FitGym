...
<body>
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="FitGym.html" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="Lo.jpg" class="h-10 logo-navbar" alt="">
...
<body>
    ...
    <section class="hero">
        <div class="content">
            <h1>Strength <span>Class</span></h1>
            <p>
                Kelas yang berfokus pada penguatan otot melalui berbagai bentuk latihan ketahanan. 
                Kelas ini dirancang untuk meningkatkan kekuatan fisik, membangun massa otot, dan meningkatkan daya tahan tubuh anda.
            </p>
    
        </div>
        <img src="https://i.pinimg.com/736x/e4/21/01/e42101d3d80d9fec0b175de093949587.jpg" alt="Mind & Body Class">
    </section>
