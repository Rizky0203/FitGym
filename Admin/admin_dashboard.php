...
<body>
    ...
    <div class="navbar">
        ...
        <a href="../AdminMerch/tambah.php" class="btn">+ Daftar Anggota</a>
...
<?php } ?>
    ...
    <div class="section">
        ...
        <table>
            <tr>
                <th>No</th><th>id</th><th>username</th><th>email</th><th>role</th><th>status_membership</th><th>Aksi</th>
            </tr>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($row['status_membership']); ?></td>
                <td>
