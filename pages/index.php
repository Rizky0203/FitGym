...
<body>
 ...
 <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0px border-b border-gray-200 dark:border-gray-600">
     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="#" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="Lo.jpg" class="h-10" alt="">
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">FitGym</span>
        </a>
     <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
         <a href="Login2.html">
        <button type="button" class="text-dark bg-[#42f5f2] hover:bg-[#42f5da] focus:ring-4 focus:outline-none focus:ring-[#42f5da] font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-[#42f5da] dark:hover:bg-[#42f5da] dark:focus:ring-[#42f5da]">Login</button>
        ...
        <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
          <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
                <a href="Membership2.html" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#42f5da] md:p-0 md:dark:hover:text-[#42f5da] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Membership</a>
            </li>
            <li>
              <a href="TombolPersonalTrainer.html" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#42f5da] md:p-0 md:dark:hover:text-[#42f5da] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Personal  Trainer</a>
            </li>
            <li>
                <a href="TombolKelas.html" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#42f5da] md:p-0 md:dark:hover:text-[#42f5da] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Kelas</a>
            </li>
            <li>
              <a href="TombolTtentangKami.html" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#42f5da] md:p-0 md:dark:hover:text-[#42f5da] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Tentang Kami</a>
            </li>
            <li>
                <a href="TombolMerchandise.html" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#42f5da] md:p-0 md:dark:hover:text-[#42f5da] dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Merchandise
...
<footer class="bg-white dark:bg-gray-900">
    ...
    <footer class="mt-5 text-center py-4 bg-gray-100 text-gray-700">
        &copy; 2024 Fit Gym Center. All Rights Reserved.
    </footer>
